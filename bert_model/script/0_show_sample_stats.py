...
if __name__ == '__main__':
    length_process('/data2/code/DaguanFengxian/bert_model/data/datagrand_2021_train.csv')
    length_process('/data2/code/DaguanFengxian/bert_model/data/datagrand_2021_test.csv')
