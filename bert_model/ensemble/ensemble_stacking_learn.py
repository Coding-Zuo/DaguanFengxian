...
class Ensemble:
    def __init__(self):
        self.x_train = None  # (398,30)  、79
        self.x_test = None  # (171,30)
        self.y_train = None  # (398)
        self.y_test = None  # (171)
        self.k = 5

    def load_data(self):
        x, y = load_breast_cancer(return_X_y=True)  # (569,30) (569)
    ...
    def k_fold_cross_validation(self, clf):
        ...
        return predictions_clf  # 单模型k折结果
