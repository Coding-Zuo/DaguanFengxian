...
class FGM:
    ...
    def attack(self, epsilon=8 / 255, emb_name='layers.0.O.weight'):
    ...
    def restore(self, emb_name='layers.0.O.weight'):
        for name, param in self.model.named_parameters():
            if param.requires_grad and emb_name in name:
...
class PGD:
    ...
    def attack(self, epsilon=8 / 255, alpha=10 / 255, emb_name='embeddings.word_embeddings.weight',
